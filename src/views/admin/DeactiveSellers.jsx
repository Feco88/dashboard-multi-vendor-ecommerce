...
//'get_deactive_sellers' metódus meghívása a Reducer-ből dispatch()-el,
...
<div className='px-2 lg:px-7 pt-5'>
  <h1 className='text-[20px] font-bold mb-3'>Letiltott eladók</h1>
...
{/*Táblázat a Letiltott eladókhoz */}
