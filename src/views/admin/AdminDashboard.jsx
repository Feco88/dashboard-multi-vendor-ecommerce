...
const AdminDashboard = () => {
 ...
 const {totalSale,totalOrder,totalProduct,totalSeller,recentOrder,
         ...
         md:grid-cols-2 lg:grid-cols-4 gap-5'>
            ...
            p-5 bg-[#fae8e8] rounded-md gap-3'>
                ...
                text-[#5c5a5a]'>
                    ...
                    <span className='text-md font-medium'>Eladás</span>
                </div>
            ...
            p-5 bg-[#e9feea] rounded-md gap-3'>
                <div className='flex flex-col justify-start items-start
                text-[#5c5a5a]'>
                    <h2 className='text-xl font-bold'>{totalSeller}</h2>
                    <span className='text-md font-medium'>Eladó</span>
                </div>
                <div className='w-[40px] h-[40px] rounded-full
...
<div className='flex flex-col gap-2 pt-3 text-[#d0d2d6]'>
    ...
    {/*bejelentkezett eladó azonosítója alapján kép megjelenítése*/}
     {
        m.senderId === userInfo._id ? <img className='w-full 
        rounded-full h-full shadow-lg'
        src={userInfo.image} /> : <img className='w-full 
        rounded-full h-full shadow-lg'
        src={seller} />
     }
     ...
     <tbody>
      {
       ...
       <td scope='row' className='py-3 px-4 font-medium 
       whitespace-normal'>
        <Link to={`/admin/dashboard/order/details/${d._id}`}>Megtekintés</Link></td>
       </tr>)
      }
     </tbody>
    </table>
