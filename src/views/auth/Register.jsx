 ...
 <div className='min-w-screen min-h-screen bg-[#cbf0ff] flex justify-center items-center' >
    <div className='w-[350px] text-[#ffffff] p-2'>
        <div className='bg-[#1877F2] p-4 rounded-md'>
            ...
            <p className='text-sm mb-3 font-medium'>Hozz létre egy fiókot</p>
            <form onSubmit={submit}>
                <div className='flex flex-col w-full gap-1 mb-3'>
                    ...
                    className='px-3 py-2 outline-none border
                        ...
                        type="text" name='name' placeholder='Teljes név' id='name' required />
                </div>
                <div className='flex flex-col w-full gap-1 mb-3'>
                ...
                <div className='flex items-center w-full gap-3 mb-3'>
                    ...
                    <label htmlFor="checkbox">Elfogadom az adatvédelmi nyilatkozatot és feltételeket*</label>
                </div>
                <div className='pb-4 flex justify-start items-center'>
                    <small className='font-bold text-white'>A *-gal jelölt mezők kitöltése kötelező!</small>
                </div>
            ...
            text-white rounded-md px-7 py-2 mb-3'>
                ...
                <div className='flex items-center mb-3 gap-3 justify-center'>
                    <p>Van már fiókod ? <Link className='font-bold' to="/login">Bejelentkezek</Link></p>
                </div>
