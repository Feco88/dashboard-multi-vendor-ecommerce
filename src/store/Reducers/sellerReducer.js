...
// Eladó megjelenítése metódus kezdete
...
//Eladó megjelenítése metódus vége

// Eladó adatainak kiíratása metódus kezdete
...
// Eladó adatainak kiíratása metódus vége
// Eladó aktiválása/tiltása metódus kezdete
...
// Eladó aktiválása/tiltása metódus vége
// Aktív Eladók megjelenítése metódus kezdete
...
// Deaktív Eladók megjelenítése metódus kezdete
export const get_deactive_sellers = createAsyncThunk(
    'seller/get_deactive_sellers',
     async({ parPage,page,searchValue },{rejectWithValue, fulfillWithValue}) => {
       try {
        const {data} = await api.get(`/get-deactive-sellers?page=${page}
        &&searchValue=${searchValue}&&parPage=${parPage}`,
        {withCredentials: true})
        return fulfillWithValue(data)
       } catch (error) {
...
// Eladó - Profilom aloldalon fizetési rész metódus
...
// Eladó - Profilom aloldalon fizetési rész metódus vége
// Eladó - fizetési rendszer aktiválása metódus
...
// Eladó - fizetési rendszer aktiválása metódus vége
...
//export default authReducer.reducer; (Kazi által)
